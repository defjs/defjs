...
export function getFieldMetadata<T>(field: Field<T>): FieldMetadata<ExtractFieldValue<T>> {
	return field[FIELD]
}

export function validatorField(validators: ValidatorFn[], value: unknown): void {
...
export async function asyncValidatorField(asyncValidator: AsyncValidatorFn[], value: unknown): Promise<void> {
