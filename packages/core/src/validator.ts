export type ValidatorFn<T = unknown> = <I>(value: I | T) => Error | null | undefined
export type AsyncValidatorFn<T = unknown> = <I>(value: I | T) => Promise<Error | null | undefined>

export const required: ValidatorFn = <T>(value: T) => {
	if (!value) {
...
export const requiredTrue: ValidatorFn = <T>(value: T) => {
